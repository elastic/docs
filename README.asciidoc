...
You'll need `bash`, `git`, and `docker`.
...
[partintro]
--
The `build_docs.sh` executable can be used to build the documentation
...
correctly, use `build_docs.sh` with the `--doc` parameter to
generate the HTML version of the docs:

[source,bash]
----------------------------
cd path/to/your/repo
~/path/to/docs/repo/build_docs.sh --doc path/to/index.asciidoc
----------------------------
...
[source,bash]
----------------------------
build_docs.sh --doc path/to/index.asciidoc --out output/dir/
----------------------------
...
[source,bash]
----------------------------
build_docs.sh --doc path/to/index.asciidoc --open
----------------------------
...
[source,bash]
----------------------------
build_docs.sh --doc path/to/index.asciidoc --single
----------------------------
...
[source,bash]
----------------------------
build_docs.sh --doc path/to/index.asciidoc --single --toc
----------------------------
...
[source,bash]
----------------------------
build_docs.sh --doc path/to/index.asciidoc --chunk 1
----------------------------
...
You can do this by telling `build_docs.sh` to ignore errors with the `--lenient`
parameter:

[source,bash]
----------------------------
build_docs.sh --doc path/to/some/page.asciidoc --lenient --single --open
----------------------------
...
Cross document links are checked when `build_docs.sh` is
...
[source,sh]
---------------
build_docs.sh -d my_doc.asciidoc --open <1> --web <2>
---------------

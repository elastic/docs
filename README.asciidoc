...
The `branches` key lists all of the branches which should be built for that book -- all of these branches will be available on the website. The `current` key lists the branch which

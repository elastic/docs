...
# Cloud
alias docbldech='$GIT_HOME/docs/build_docs --doc $GIT_HOME/cloud/docs/saas/index-heroku.asciidoc --resource=$GIT_HOME/cloud/docs/shared --resource=$GIT_HOME/cloud/docs/heroku --chunk 1'

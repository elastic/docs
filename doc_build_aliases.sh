...
# Elasticsearch
alias docbldesx='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/elasticsearch/docs/reference/index.asciidoc --resource=$GIT_HOME/elasticsearch/x-pack/docs/ --chunk 1'
...
alias docbldstkold='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/stack-docs/docs/en/install-upgrade/index.asciidoc --resource=$GIT_HOME/elasticsearch/docs/ --chunk 1'


# Glossary
alias docbldgls='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/stack-docs/docs/en/glossary/index.asciidoc --resource=$GIT_HOME/elasticsearch/docs'

# Getting started
alias docbldgs='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/stack-docs/docs/en/getting-started/index.asciidoc --chunk 1'

# Stack Overview
alias docbldso='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/stack-docs/docs/en/stack/index.asciidoc --resource $GIT_HOME/elasticsearch/docs --chunk 1'

# Stack Overview versions 6.3-7.2
alias docbldsoold=docbldso

# Deploying Azure
alias docbldaz='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/azure-marketplace/docs/index.asciidoc --chunk 1'
...
alias docbldece='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/cloud/docs/cloud-enterprise/index.asciidoc --resource=$GIT_HOME/cloud/docs/shared --chunk 1'
...
alias docbldfb='$GIT_HOME/docs/build_docs --direct_html --respect_edit_url_overrides --doc $GIT_HOME/beats/filebeat/docs/index.asciidoc --chunk 1'

alias docbldwb='$GIT_HOME/docs/build_docs --direct_html --respect_edit_url_overrides --doc $GIT_HOME/beats/winlogbeat/docs/index.asciidoc --chunk 1'

alias docbldmb='$GIT_HOME/docs/build_docs --respect_edit_url_overrides --direct_html --doc $GIT_HOME/beats/metricbeat/docs/index.asciidoc --chunk 1'

alias docbldhb='$GIT_HOME/docs/build_docs --respect_edit_url_overrides --direct_html --doc $GIT_HOME/beats/heartbeat/docs/index.asciidoc --chunk 1'

alias docbldab='$GIT_HOME/docs/build_docs --direct_html --respect_edit_url_overrides --doc $GIT_HOME/beats/auditbeat/docs/index.asciidoc --chunk 1'
alias docbldabx='$GIT_HOME/docs/build_docs --direct_html --respect_edit_url_overrides --doc $GIT_HOME/beats/auditbeat/docs/index.asciidoc --resource=$GIT_HOME/beats/x-pack/auditbeat --chunk 1'

alias docbldfnb='$GIT_HOME/docs/build_docs --direct_html --respect_edit_url_overrides --doc $GIT_HOME/beats/x-pack/functionbeat/docs/index.asciidoc --chunk 1'

alias docbldjb='$GIT_HOME/docs/build_docs --direct_html --respect_edit_url_overrides --doc $GIT_HOME/beats/journalbeat/docs/index.asciidoc --chunk 1'
...
alias docbldamp='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/apm-agent-python/docs/index.asciidoc --chunk 1'

alias docbldamry='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/apm-agent-ruby/docs/index.asciidoc --chunk 1'

alias docbldamj='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/apm-agent-java/docs/index.asciidoc --chunk 1'

alias docbldamjs='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/apm-agent-rum-js/docs/index.asciidoc --chunk 1'

alias docbldamgo='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/apm-agent-go/docs/index.asciidoc --chunk 1'
...
alias docbldejv='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/elasticsearch/docs/java-api/index.asciidoc --chunk 1'

alias docbldejs='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/elasticsearch-js/docs/index.asciidoc'
...
alias docbldx='$GIT_HOME/docs/build_docs --direct_html --doc $GIT_HOME/x-pack/docs/en/index.asciidoc --resource=$GIT_HOME/kibana-extra/x-pack-kibana/docs --resource=$GIT_HOME/elasticsearch-extra/x-pack-elasticsearch/docs --chunk 1'

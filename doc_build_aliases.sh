...
alias docbldkbx='$GIT_HOME/docs/build_docs.pl --doc $GIT_HOME/x-pack-kibana/docs/en/index.asciidoc --resource=$GIT_HOME/kibana/docs/ --chunk 1'

# Logstash
alias docbldls='$GIT_HOME/docs/build_docs.pl --doc $GIT_HOME/logstash/docs/index.asciidoc --chunk 1'

alias docbldlsx='$GIT_HOME/docs/build_docs.pl --doc $GIT_HOME/logstash-extra/x-pack-logstash/docs/en/index.asciidoc --resource=$GIT_HOME/logstash/docs/ --resource=$GIT_HOME/logstash-docs/docs/ --chunk 1'
...
alias docbldx='$GIT_HOME/docs/build_docs.pl --doc $GIT_HOME/x-pack/docs/en/index.asciidoc --resource=$GIT_HOME/x-pack-kibana/docs --resource=$GIT_HOME/elasticsearch-extra/x-pack-elasticsearch/docs --chunk 1'

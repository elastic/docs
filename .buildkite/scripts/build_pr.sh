...
GITHUB_PR_BRANCH=${GITHUB_PR_BRANCH:="do-not-merge-buildkite-validation"}
GITHUB_PR_TARGET_BRANCH=${GITHUB_PR_TARGET_BRANCH:="main"}
GITHUB_PR_NUMBER=${GITHUB_PR_NUMBER:="4392"}
GITHUB_PR_BASE_REPO=${GITHUB_PR_BASE_REPO:="security-docs"}

...
Reusable images
//////////
:yes-icon:         image:https://doc-icons.s3.us-east-2.amazonaws.com/icon-yes.png[link="{yes-icon}",Yes,20,15,title="Supported"]
:no-icon:          image:https://doc-icons.s3.us-east-2.amazonaws.com/icon-no.png[link="{no-icon}",No,20,15, title="Not supported"]

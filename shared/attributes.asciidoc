...
:dataframe-transform-cap:    {dataframe-cap} transform
...
:cdataframe-transform:       continuous {dataframe-transform}
:cdataframe-transforms:      continuous {dataframe-transforms}
:cdataframe-transforms-cap:  Continuous {dataframe-transforms}
...
:con-targvar:                continuous target variable

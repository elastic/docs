...
:ess-leadin: You can run Elasticsearch on your own hardware or use Elastic Coud Hosted, available on AWS, GCP, and Azure. {ess-trial}[Try the Elastic CLoud Hosted for free].
